...
export default function Banner() {
    return (
        <div className='w-full px-[100px] py-[50px] mb-[50px] flex items-center justify-center '>
            <div className='relative w-full max-w-[1440px] py-16 flex flex-col rounded-md overflow-hidden items-center justify-center text-white font-semibold bg-cover bg-center' style={{backgroundImage: 'url("/green_back.png")'}}>
                ...
                <div className='absolute left-0 bottom-0 z-[6]'>
                    <img src="/left.png" alt='left_group' />
                </div>
                <div className='absolute right-0 top-[0]'>
                    <img src="/right.png" alt='right_group' className='' />
                </div>
            </div>
        </div>
    )
